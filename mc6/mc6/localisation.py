...
class Localisation(Node):
    def __init__(self):
        ...
        # Subscribers
        self.wr_sub = self.create_subscription(Float32, "VelocityEncR", self.wr_cb, 10) 
        self.wl_sub = self.create_subscription(Float32, "VelocityEncL", self.wl_cb, 10) 
    ...
    def create_odom_msg(self):
        ...
        # Publish the message
        #self.get_logger().info(f"Publishing odometry: position=({self.x:.2f}, {self.y:.2f}), orientation={self.theta:.2f} rad")
